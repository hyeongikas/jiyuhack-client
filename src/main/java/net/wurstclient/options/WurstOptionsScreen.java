...
public class WurstOptionsScreen extends Screen
{
	...
	private void addLinkButtons()
	{
		...
		new WurstOptionsButton(54, 24, () -> "Official Website",
			"§n§ljiyubear.co", b -> os.open("https://jiyubear.co"));
		
		new WurstOptionsButton(54, 48, () -> "Jiyuhack Wiki",
			"§n§ljiyubear.co\n"
				+ "We are looking for volunteers to help us expand"
				+ " the wiki and keep it up to date with the latest Wurst updates.",
			b -> os.open("https://jiyubear.co"));
		
		new WurstOptionsButton(54, 72, () -> "Jiyuhack",
			"§n§lhttps://jiyubear.co", b -> os.open("https://jiyubear.co"));
		
		new WurstOptionsButton(54, 96, () -> "Twitter", "@cocoseyo",
			b -> os.open("https://jiyubear.co"));
		
		new WurstOptionsButton(54, 120, () -> "Donate",
			"§n§lWurstClient.net/donate\n"
				+ "Donate now to help me keep the jiyuhack Client alive and free"
				+ " to use for everyone.\n\n"
	...
	private void renderTitles(DrawContext context)
	{
		...
		context.drawCenteredTextWithShadow(tr, "Jiyuhack Options", middleX, y1,
			0xffffff);
